export const icons = {
    ...
    chevron_up: (
        <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_2497_25896)">
                <path d="M17 14L12 9" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M12 9L7 14" strokeLinecap="round" strokeLinejoin="round" />
            </g>
            <defs>
    ...
    chevron_down: (
        <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_2497_25897)">
                <path d="M7 10L12 15" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M12 15L17 10" strokeLinecap="round" strokeLinejoin="round" />
            </g>
            <defs>
                <clipPath id="clip0_2497_25897">
                    <rect width="24" height="24" />
                </clipPath>
            </defs>
        </svg>
    ...
    chevron_left: (
        <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_2497_25894)">
                <path d="M14 7L9 12" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M9 12L14 17" strokeLinecap="round" strokeLinejoin="round" />
            </g>
            <defs>
    ...
    chevron_right: (
        <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_4596_2429)">
                <path d="M10 17L15 12" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M15 12L10 7" strokeLinecap="round" strokeLinejoin="round" />
            </g>
            <defs>
    ...
    three_dots: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M11 18C11 18.5523 11.4477 19 12 19C12.5523 19 13 18.5523 13 18C13 17.4477 12.5523 17 12 17C11.4477 17 11 17.4477 11 18Z" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M11 12C11 12.5523 11.4477 13 12 13C12.5523 13 13 12.5523 13 12C13 11.4477 12.5523 11 12 11C11.4477 11 11 11.4477 11 12Z" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M11 6C11 6.55228 11.4477 7 12 7C12.5523 7 13 6.55228 13 6C13 5.44772 12.5523 5 12 5C11.4477 5 11 5.44772 11 6Z" strokeLinecap="round" strokeLinejoin="round" />
        </svg>

    ),
    percentage: (
        <svg width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M9 6C9 7.65685 7.65685 9 6 9C4.34315 9 3 7.65685 3 6C3 4.34315 4.34315 3 6 3C7.65685 3 9 4.34315 9 6Z" strokeLinecap="round" strokeLinejoin="round" />
    ...
    rupee: (
        <svg width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M6 4H10.5M10.5 4C12.9853 4 15 6.01472 15 8.5C15 10.9853 12.9853 13 10.5 13H6L13 20M10.5 4H18M6 8.5H18" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    ),
